...
def start_training(character):
    """
    Принимает на вход объект персонажа.
    Возвращает сообщения о результатах цикла тренировки персонажа.
    """
    print('Потренируйся управлять своими навыками.')
    print('Введи одну из команд: attack, defence, special для выполнения действия.')
    ...
    while True:
        ...
        if cmd == 'skip':
            break
        print(commands.get(cmd, lambda: "Неизвестная команда. Пожалуйста, попробуйте еще раз.")())
